...
print("\n🚀 Next steps:")
print('  1. Generate workflow: wfe generate "Detect objects in video"')
print("  2. Run workflow: wfe run workflows/granular_video_detection_mp4.json")
print("  3. Optimize workflow: wfe optimize workflows/granular_video_detection_mp4.json")
print("  4. Watch the system learn and optimize automatically!")
